...
def UNET_att_right(X, X_left, channel, att_channel, kernel_size=3, stack_num=2,
    ...
    H = tf.concat([X, X_left], axis=-1, name='{}_concat'.format(name))
...
def att_unet_2d(input_size=None, filter_num=None, n_labels=32, stack_num_down=2, stack_num_up=2, activation='ReLU',
