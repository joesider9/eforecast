...
def unet_plus_2d(input_size=None, filter_num=None, n_labels=32, stack_num_down=2, stack_num_up=2,
    ...
    # model
    model = tf.keras.Model(inputs=[IN, ], outputs=OUT_list, name='{}_model'.format(name))
