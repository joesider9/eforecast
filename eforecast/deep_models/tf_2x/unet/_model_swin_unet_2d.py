...
from eforecast.deep_models.tf_2x.unet.transformer_layers import patch_extract, patch_embedding, SwinTransformerBlock, patch_merging, patch_expanding
...
def swin_unet_2d_base(input_tensor, filter_num_begin, depth, stack_num_down, stack_num_up, 
    ...
    for i in range(depth_decode):
        ...
        X = tf.concat([X, X_decode[i]], axis=-1, name='{}_concat_{}'.format(name, i))
...
def swin_unet_2d(input_size, filter_num_begin, n_labels, depth, stack_num_down, stack_num_up, 
                      patch_size, num_heads, window_size, num_mlp, output_activation='Softmax',
