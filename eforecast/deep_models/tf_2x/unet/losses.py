...
def dice_coef(y_true, y_pred, const=tf.keras.backend.epsilon()):
    '''
...
def dice(y_true, y_pred, const=tf.keras.backend.epsilon()):
    '''
    Sørensen–Dice Loss.
...
def tversky_coef(y_true, y_pred, alpha=0.5, const=tf.keras.backend.epsilon()):
    '''
...
def tversky(y_true, y_pred, alpha=0.5, const=tf.keras.backend.epsilon()):
    '''
    Tversky Loss.
...
def focal_tversky(y_true, y_pred, alpha=0.5, gamma=4 / 3, const=tf.keras.backend.epsilon()):
    '''
