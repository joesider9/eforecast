...
from eforecast.deep_models.pytorch_2x.ts_transformers.utils.masking import TriangularCausalMask, ProbMask
...
class TwoStageAttentionLayer(nn.Module):
    ...
    def __init__(self, 
                 seg_num, factor, d_model, n_heads, d_ff=None, dropout=0.1, output_attention=False):
