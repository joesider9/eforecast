...
from eforecast.deep_models.pytorch_2x.ts_transformers.layers.SelfAttention_Family import TwoStageAttentionLayer
...
class scale_block(nn.Module):
    def __init__(self,  win_size, d_model, n_heads, d_ff, depth, dropout, \
                 seg_num=10, factor=10, output_attention=False):
